...
# Copyright (c) 2018 qyou.casia@gmail.com
...
from openpyxl.chart.reader import find_charts, find_images
        ...
        if read_only:
            ...
            if rels:
                ...
                for rel in drawings:
                    ...
                    for img in find_images(archive, rel.target):
                        ws.add_image(img, img.anchor)
